...
function bcreate_add_admin_page() {
    ...
    add_submenu_page('bcreate_theme_options', 'bCreate Styling Options', 'Styling Options', 'manage_options', 'bcreate_theme_options_styling', 'bcreate_create_admin_page_styling');

    // Activate custom settings
    add_action('admin_init', 'bcreate_custom_settings');
}
...
function bcreate_create_admin_page_styling() {
    require_once(get_stylesheet_directory() . '/templates/admin-pages/admin-theme-options-styling.php');
}